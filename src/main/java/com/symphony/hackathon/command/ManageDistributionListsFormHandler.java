...
@Slf4j
@Service
public class ManageDistributionListsFormHandler implements ElementsResponse {
    ...
    public ManageDistributionListsFormHandler(SymBotClient bot,
    ...
    public void execute(User user, SymphonyElementsAction action) {
        ...
        String message = template.compile("manage-distribution-lists-form", data);
